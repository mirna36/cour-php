...
<body>
	...
	<div class="w3-container">
				...
				<div class="w3-row w3-white">
					...
					<div class="w3-container w3-half">
						...
						<p class="w3-right-align"><a href="../../controllers/monument/MonumentPanierAccept.php?dateCreation=<?php echo $monument['date_creation']; ?>
								...
								<button a href="indexListerPanierAccept.php" class="w3-btn w3-yellow w3-round-large w3-hover-green w3-small"><i class="fa fa-pencil-square-o" ></i>&nbsp;&nbsp;Ajouter au panier</button></a>&nbsp;&nbsp;
						</p>
					</div>
				</div>			
		...
		<footer class="w3-brown w3-padding-large">
			<a href="frmPanier.php" >&nbsp;&nbsp;<button class="w3-btn w3-teal w3-round-large w3-hover-green w3-medium"><i class="fa fa-shopping-basket" ></i>&nbsp;&nbsp;Mon panier</button></a>	
