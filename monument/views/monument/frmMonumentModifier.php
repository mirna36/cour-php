	...
	<div class="w3-row">
		...
		<div class="w3-half w3-light-grey w3-border w3-card-4">
			...
			<div class="w3-container" >
				<label>Nom</label>
				<input class="w3-input w3-text-blue" type="text" name="nomMonument" value="<?php echo $monument['Nom_Monument']; ?>">
				<label>Arrondissement</label>
				<input class="w3-input w3-text-blue" type="text" name="arrMonument" value="<?php echo $monument['Arrondissement_Monument']; ?>" >
				<label>Adresse</label>
				<input class="w3-input w3-text-blue" type="text" name="adrMonument" value="<?php echo $monument['Adresse_Monument'];?>">
				<label>Site web</label>
				<input class="w3-input w3-text-blue" type="text" name="siteMonument" value="<?php echo $monument['Site_Web_Monument'];?>">
				<label>Date création</label>
				<input class="w3-input w3-text-blue" type="date" name="dateCreation" value="<?php echo $monument['date_creation'];?>">
