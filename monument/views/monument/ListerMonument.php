		...
		<div class="w3-container w3-responsive">
			<table class="w3-table w3-striped w3-border w3-hoverable w3-small">
				...
				<tbody>
					...
					<tr>
						<td><img id="img_monument" src="../../image/monument/monument_<?php echo $monument['ID_Monument'].".png"; ?>"alt="photo du monument" /></td>
						...
						<a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=4"><button class="w3-btn w3-purple w3-round-large w3-hover-green w3-small"><i class="fas fa-download"></i></i>&nbsp;&nbsp;Téléchargement</button></a></td>
					</tr>
					<?php
						} } else { ?>
							<tr>
